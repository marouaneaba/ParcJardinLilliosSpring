...
public class ajoutimage {
	...
	public void ajouterPJ(Model model, @RequestParam("file") MultipartFile file) {
		 ...
		 * File(dir.getAbsolutePath()+ File.separator + "hello.jpg");
	...
	/*
	 * @PostMapping(value = "/addImagee") public void ajouterPJ( Model
	 * model,@RequestParam("file") MultipartFile[] files) {
	 * System.out.println("arrivé");
	 * 
	 ...
	 * try { byte[] bytes = file.getBytes();
	 * 
	 * // Creating the directory to store file File dir = new
	 * File("./src/main/resources/static/images/imageApp" ); if (!dir.exists())
	 * dir.mkdirs();
	 * 
	 * // Create the file on server File serverFile = new
	 * File(dir.getAbsolutePath()+ File.separator + "hello"+i+".jpg");
	 * BufferedOutputStream stream = new BufferedOutputStream(new
	 * FileOutputStream(serverFile)); stream.write(bytes); stream.close();
	 * 
	 ...
	 * 
	 * 
	 * File dir = new File("./src/main/resources/static/images/imageApp" ); if
	 ...
	 * 
	 * 
	 * System.out.println("You successfully uploaded file"); }catch(Exception
