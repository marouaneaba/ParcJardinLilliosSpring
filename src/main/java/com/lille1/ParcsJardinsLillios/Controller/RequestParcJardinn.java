package com.lille1.ParcsJardinsLillios.Controller;
...
import com.lille1.ParcsJardinsLillios.Repository.ParcJardinnRepository;
...
public class RequestParcJardinn {
	...
	@RequestMapping(method = RequestMethod.POST)
	 public void JardinnSet(@RequestParam("name")String name,
		...
		mParcJardinnRepostory.save(new ParcJardinn(name,description,parc,l,g,null,null,null));
	 }
