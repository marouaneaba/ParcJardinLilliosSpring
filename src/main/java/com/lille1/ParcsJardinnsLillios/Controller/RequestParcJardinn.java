package com.lille1.ParcsJardinnsLillios.Controller;
...
import com.lille1.ParcsJardinnsLillios.Repository.ParcJardinnRepository;
...
public class RequestParcJardinn {
	...
	@RequestMapping(method = RequestMethod.POST)
	 public void JardinnSet(@RequestParam("name")String name,
		...
		mParcJardinnRepostory.save(new ParcJardinn(name,description,parc));
	 }
