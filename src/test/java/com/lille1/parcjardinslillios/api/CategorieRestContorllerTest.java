...
public class CategorieRestContorllerTest {
	...
	public void testJsonCategorie() throws ClientProtocolException, IOException{
	    ...
	    while(iterator1.hasNext() ){
	    	...
	    	boolean assertTestTrue = tagName.equals("ETUDE") || tagName.equals("SPORT") || tagName.equals("RESTAURATION")
					|| tagName.equals("PROMENER") || tagName.equals("ECOUTER") || tagName.equals("OBSERVER");
